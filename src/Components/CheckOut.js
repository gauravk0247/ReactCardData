    ...
    return (
        <div className="container-md mt-5">
            <div className="row my-checkout width-90">
                ...
                <div className="col-md-6">
                    <label htmlFor="validationServer02" className="form-label">Item name</label>
                    <input type="text" className="form-control" id="validationServer02" required />
                    <div className="valid-feedback">Looks good!</div>
                </div>

                <div className="col-12">
                    <label htmlFor="validationServer03" className="form-label">Shipping</label>
                ...
                <div className="col-12">
                    <label htmlFor="validationServer06" className="form-label">Total</label>
